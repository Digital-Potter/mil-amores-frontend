...
const OutlinedButton = (props: OutlinedButtonProps) => {
	...
	const commonClasses =
		'relative text-xs lg:text-sm flex items-center bg-dp-softer-ma-cream hover:bg-dp-ma-orange text-dp-highlighter-ma-green font-primary-font uppercase font-bold px-4 py-3.5 rounded-4xl border-2 border-dp-dark md:px-9 md:py-4 hover:border-dp-ma-orange transition-all group shadow-2xl';
