				...
				<div className="flex flex-col items-center gap-9 p-8 text-center">
					...
					<div>
						...
						<p className="text-balance">
							Every drink and dish at Mil Amores is handcrafted with care, using
							real ingredients and time-tested techniques. From cocktails to
							comfort food, we focus on quality you can taste in every bite and
							sip.
						</p>
					</div>
				</div>
				...
				<div className="flex flex-col items-center gap-9 p-8 text-center">
					...
					<div>
						...
						<p className="text-balance">
							...
							That’s why Mil Amores delivers bold flavor and handcrafted quality
							at prices that make coming back easy.
						</p>
					</div>
				</div>
			</div>
